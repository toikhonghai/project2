...
private val steps = persistentListOf( // danh sách các mảng Float, mỗi mảng tương ứng với một thanh nhạc.
...
fun MusicBars(
    ...
    space: Dp = 4.dp // khoảng cách giữa các thanh
) {
    val animatables = remember { List(steps.size) { Animatable(0f) } } // danh sách các giá trị có thể thay đổi theo thời gian (Animatable), dùng để lưu trạng thái hoạt ảnh cho từng thanh.
